...
from constants import CHROMA_SETTINGS, EMBEDDINGS_MODEL, PERSIST_DIRECTORY
...
EMBEDDINGS = HuggingFaceInstructEmbeddings(model_name=EMBEDDINGS_MODEL, model_kwargs={"device": DEVICE_TYPE})
